  ...
  <div class="col-md-8" style="margin-top: 3%;">
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
      ...
      <div class="tab-pane fade" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
        ...
        <div class="col-md-8">
                  <input type="text" name="age" class="form-control" placeholder="Age" value="age"></div><br><br>

                  <div class="col-md-4"><label>Blood Group</label></div>
                  <div class="col-md-8">
                    <!-- <input type="time" class="form-control" name="apptime"> -->
                    <select name="Blood-Group" class="form-control" id="Blood-Group" required="required">
                  ...
                  <div class="col-md-4">
                  <label for="medical-condition">Past Medical History:</label>
                        </div>

                        <div class="col-md-8">
    <select id="medical-condition" name="medical-condition" class="form-control">
        <option value="diabetes">Diabetes mellitus</option>
        <option value="hypertension">Hypertension</option>
        <optgroup label="Asthma">
            <option value="allergic-asthma">Allergic asthma</option>
            <option value="non-allergic-asthma">Non-allergic asthma</option>
        </optgroup>
        <optgroup label="Chronic obstructive pulmonary disease (COPD)">
            <option value="emphysema">Emphysema</option>
            <option value="chronic-bronchitis">Chronic bronchitis</option>
        </optgroup>
        <optgroup label="Rheumatoid arthritis">
            <option value="seropositive-ra">Seropositive RA</option>
            <option value="seronegative-ra">Seronegative RA</option>
        </optgroup>
    </select>
    </div>
    <br><br><br>  
